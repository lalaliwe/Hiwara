...
Enables the enter_immersive command without any pre-configured scope.
...
`device:deny-enter-immersive`

</td>
<td>

Denies the enter_immersive command without any pre-configured scope.
...
Enables the exit_immersive command without any pre-configured scope.
...
Enables the lock_orientation command without any pre-configured scope.
...
`device:deny-lock-orientation`

</td>
<td>

Denies the lock_orientation command without any pre-configured scope.
...
Enables the unlock_orientation command without any pre-configured scope.
...
`device:deny-unlock-orientation`
